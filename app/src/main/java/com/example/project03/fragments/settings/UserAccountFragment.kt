package com.example.project03.fragments.settings
...
import com.example.project03.databinding.FragmentUserAccountBinding
import com.example.project03.dialog.setupBottomSheetDialog
import com.example.project03.util.Resource
import com.example.project03.viewmodel.UserAccountViewMoldel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSave.setOnClickListener {
            binding.apply {
                ...
                val user=User(fistName,lastName,email)
